...
typedef enum {
	/** No error. */
	WXSSKeyChainErrorNone = noErr,
	
	/** Some of the arguments were invalid. */
	WXSSKeyChainErrorBadArguments = -1001,
	
	/** There was no password. */
	WXSSKeyChainErrorNoPassword = -1002,
	
	/** One or more parameters passed internally were not valid. */
	WXSSKeyChainErrorInvalidParameter = errSecParam,
	
	/** Failed to allocate memory. */
	WXSSKeyChainErrorFailedToAllocated = errSecAllocate,
	
	/** No trust results are available. */
	WXSSKeyChainErrorNotAvailable = errSecNotAvailable,
	
	/** Authorization/Authentication failed. */
	WXSSKeyChainErrorAuthorizationFailed = errSecAuthFailed,
	
	/** The item already exists. */
	WXSSKeyChainErrorDuplicatedItem = errSecDuplicateItem,
	
	/** The item cannot be found.*/
	WXSSKeyChainErrorNotFound = errSecItemNotFound,
	
	/** Interaction with the Security Server is not allowed. */
	WXSSKeyChainErrorInteractionNotAllowed = errSecInteractionNotAllowed,
	
	/** Unable to decode the provided data. */
	WXSSKeyChainErrorFailedToDecode = errSecDecode
} WXSSKeyChainErrorCode;

extern NSString *const kWXSSKeyChainErrorDomain;

/** Account name. */
extern NSString *const kWXSSKeyChainAccountKey;
 ...
 */
extern NSString *const kWXSSKeyChainCreatedAtKey;

/** Item class. */
extern NSString *const kWXSSKeyChainClassKey;

/** Item description. */
extern NSString *const kWXSSKeyChainDescriptionKey;

/** Item label. */
extern NSString *const kWXSSKeyChainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kWXSSKeyChainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kWXSSKeyChainWhereKey;
...
/**
 ...
 WXSSKeyChain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface WXSSKeyChain : NSObject
...
/**
 ...
 See the `NSString` constants declared in WXSSKeyChain.h for a list of keys that can be used when accessing the
